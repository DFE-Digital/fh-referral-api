    ...
    public async Task ThenTheOpenReferralIsCreatedAndNotificationIsSent()
    {
        ...
        var command = new ReferralDto
        {
            ...
            ReferralUserAccountDto = new UserAccountDto
            {
                ...
                Name = "<referrer with education account>",
        ...
        var referralDataDto = new ReferralDataDto
        {
            ReferralDto = command,
        ...
        var request = new HttpRequestMessage
        {
            ...
            RequestUri = new Uri(Client.BaseAddress + "api/referralwithnotification"),
            Content = new StringContent(Newtonsoft.Json.JsonConvert.SerializeObject(referralDataDto), Encoding.UTF8, "application/json"),
        };
